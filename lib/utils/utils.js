...
const self = module.exports = {
  ...
  updateOrCreateConfig: params => {
    // update the date of the last pull
    // save the hash of the commit
  },
  shouldIPull: params => { // move this to git.js
    // todo read config (if it exists)
    // compare dates, did I last pull >1h ago? DONT PULL, if not PULL
  },
